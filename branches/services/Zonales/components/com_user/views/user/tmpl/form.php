...
<tr>
	...
	<td>
		<input class="inputbox required validate-birthdate" type="text" id="birthdate" name="birthdate" value="
			<?php 
				echo $this->escape($this->user->get('birthdate'));
			?>
		" size="40" />
	</td>
</tr>
...
<a href="index.php?option=com_alias">
