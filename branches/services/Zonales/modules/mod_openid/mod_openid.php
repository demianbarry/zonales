...
<form id="form-openidlogin" action="<?php echo JRoute::_('index.php') ?>" method="post">
    <fieldset class="input">
        <p id="form-login-username">
            <label id="mod_login_message" name="mod_login_message" for="modlgn_username">Ingrese su identificador OpenID:</label>
            <br />
        ...
        <input id="mod_login_provider" name="provider" type="hidden" value="OpenID" />
