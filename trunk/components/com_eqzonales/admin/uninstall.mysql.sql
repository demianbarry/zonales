...
INSERT INTO `#__eqzonales_banda_bak` (`id`,`valor`,`peso`, `cp_value_id`,`eq_id`, `default`, `active`)
	SELECT `e`.`id`, `e`.`valor`, `e`.`peso`, `e`.`cp_value_id`, `e`.`eq_id`, `e`.`default`, `e`.`active` FROM `#__eqzonales_banda` `e`
