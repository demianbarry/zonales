...
require_once(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_customproperties'.DS.'contentelement.class.php');
 ...
 */
class EqZonalesControllerHierarchictagging extends JController {
    ...
    function __construct() {
        ...
        $this->addModelPath( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_customproperties'.DS.'models' );
