...
<div id="oEditor">
    <form action="<?php echo $this->action ?>" method="post" name="adminForm" onSubmit="setgood();">
        <fieldset>
            ...
            <?php
            $editor = $this->editor->display('text', $this->article->text, '100%', '400', '70', '15');
            $editor = str_replace("http://www.zonales.com.ar:50081/index.php?option=com_media&view=images&tmpl=component&e_name=text","http://www.zonales.com.ar:50081/administrator/index.php?option=com_media&view=images&tmpl=component&e_name=text",$editor);
            echo $editor;
            ?>
        </fieldset>
        <fieldset>
            ...
            <table class="adminform">
                ...
                <?php /*if ($this->user->authorize('com_content', 'publish', 'content', 'own'))*/ if(true) : ?>
