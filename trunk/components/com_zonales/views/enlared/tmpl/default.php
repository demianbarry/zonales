            ...
            onComplete: function(jsonObj) {
                ...
                if(typeof jsonObj != 'undefined'){
                    if(first)
                        ...
                        if($('newPostsContainer').getChildren().length > 0){
                            $('verNuevos').set('value',$('newPostsContainer').getChildren().length+' nuevos...');
...
$('newPostsContainer').getChildren().reverse().each(function(post){   
    post.inject($('postsContainer'),'top');
