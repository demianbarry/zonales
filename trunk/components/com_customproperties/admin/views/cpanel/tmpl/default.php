...
$lists['publishing_group']   = JHTML::_('select.genericlist',   $gtree, 'cfg_publishing_group', 'size="10"', 'value', 'text', $cp_config['publishing_group']);
...
<form action="index.php" method="post" name="adminForm">
    ...
    <table class="adminlist">
        ...
        <tr>
            <td width="20%">
                <?php echo JText::_('SYSTEM_TAG_ANALIZER') ?>:
            </td>
            <td>
                <input type="text" size="30" name="cfg_tags_analizer_url" value="<?php echo $cp_config['tags_analizer_url'];?>"/>
            </td>
            <td>
                <?php echo JText::_('SYSTEM_TAG_ANALIZER_DESCRIPTION') ?>.
            </td>
            <td>
                &nbsp;
            </td>
        ...
        <tr>
            <td width="20%">
                <?php echo JText::_('Publisher\'s group') ?>:
            </td>
            <td>
                <?php echo $lists['publishing_group'];?>
            </td>
            <td>
                <?php echo JText::_('PUBLISHER\'SGROUPTIP') ?>.
            </td>
            <td>
                &nbsp;
            </td>
