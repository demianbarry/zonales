...
/**
 * Description of render_for_DOUBLE_data_type
 *
 * @author nacho
 */
class render_for_DOUBLE_data_type {
    //put your code here

    function render($id, $value = null, $label = null, $required = null, $params = null) {

        //Si el atributo está cargado como required, agrega class="required" en el input
        $req = $required == null ? '' : $required == 0 ? '' : 'required';
        $req == 'required' ? $reqLabel = '*' : $reqLabel = '';

        //retorno: código HTML que se va a mostrar.
        $return =
            '<div class="render">
                 <td class="key">
