...
module.exports.tryEvent = function tryEvent(client) {
    ...
    client.on('addKeywordToZCtx', function(data, fn) {
        console.log('Recibí evento addKeywordToZCtx, keyword = ' + data.keyword);
