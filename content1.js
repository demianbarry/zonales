...
function contentToSolr(content){
    ...
    solrContent.verbatim = JSON.stringify(content);
    return solrContent;
} 
...
function refreshContent(){
    ...
    zContent.fromUser.name = $('autor').value;
    zContent.fromUser.id = $('autor').value;
...
function refreshForm(){
    $('autor').value = zContent.fromUser ? zContent.fromUser.name : '';
...
function getContent(id){
    var url = '/solr/select?qt=zonalesContent&wt=json&q=source:%28Zonales%29+AND+id:'+id;
