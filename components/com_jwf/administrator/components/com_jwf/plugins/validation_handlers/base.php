<?php
/**
* Base class for Validation handler plugins
*
 ...
 * @subpackage	JWF.plugins
 */
class JWFValidationHandler extends JObject{
	 
	 /**
	 * Called when an item arrives at a given station
	 * @access	public
	 * @param	object $validationParameters paremeters supplied by the user for this hook ( e.g. E-mail body for a mail hook handler ,etc)
	 ...
	 * @return	void
 	 */
	function onDeparted( $validationParameters, $workflow, $currentStation, $currentStep){return;}
}