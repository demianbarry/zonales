...
getOffsets:function(){
    if(this.getBoundingClientRect){
        ...
        return{
            x:parseInt(m.left,10)+((n)?0:i.x)-k.clientLeft,
            y:parseInt(m.top,10)+((n)?0:i.y)-k.clientTop
            };
    ...
    var b={
        wait:function(c){
            return this.chain(function(){
                this.callChain.delay($pick(c,500),this);
            }.bind(this));
        }
    };
...
try{
    Element.implement({
        chains:function(c){
            $splat($pick(c,["tween","morph","reveal"])).each(function(d){
                d=this.get(d);
                if(!d){
                    return;
                }
        ...
        pauseFx:function(d,c){
            this.chains(c).get($pick(c,"tween")).wait(d);
            return this;
        }
    });
}catch(a){}
...
Date.extend({
    ...
    getTimePhrase:function(c){
        ...
        return Date.getMsg(b+a,c).substitute({
            delta:c
        });
    }
});
...
(function(){
    var b=["�","�","�","�","�","�","�","�","�","�","�","�","A","a","A","a","C","c","C","c","�","�","D","d","�","d","�","�","�","�","�","�","�","�","E","e","E","e","G","g","�","�","�","�","�","�","�","�","L","l","L","l","L","l","�","�","N","n","N","n","�","�","�","�","�","�","�","�","�","�","�","�","o","R","r","R","r","�","�","S","s","S","s","T","t","T","t","T","t","�","�","�","�","�","�","�","�","U","u","�","�","�","�","�","�","Z","z","Z","z","�","�","�","�","�","�","�","�","�","�"];
...
this.setStyle("position","absolute");
    ...
    o={
        left:((o.x>=0||i||s.allowNegative)?o.x:0).toInt(),
        top:((o.y>=0||i||s.allowNegative)?o.y:0).toInt()
        };
...
scroll:function(){
    var b=this.element.getSize(),a=this.element.getScroll(),g=this.element.getOffsets(),c=this.element.getScrollSize(),e={
        x:0,
        y:0
    };
...
position:function(d){
    var b=window.getSize(),a=window.getScroll(),e={
