...
<div>
    ...
    <div id="ordenar"><p>Ordenar por <img src="templates/<?php echo $template; ?>/img/arrow_right.gif" /> <a id="relevantesOrder" onclick="console.log(zTab.zCtx.zcGetZTab());setZTab(zTab.zCtx.zcGetZTab() == 'noticiasenlared' ? 'noticiasenlaredrelevantes' : zTab.zCtx.zcGetZTab() == 'portada' ? 'portadarelevantes' : 'relevantes')">MÃ¡s relevantes</a> | <a id="recientesOrder" onclick="setZTab(zTab.zCtx.zcGetZTab() == 'noticiasenlaredrelevantes' ? 'noticiasenlared' : zTab.zCtx.zcGetZTab() == 'portadarelevantes' ? 'portada' : 'enlared')">MÃ¡s recientes</a></p></div>
</div>
